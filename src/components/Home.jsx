...
const Home = () => (
        <Fragment>
                ...
                <div className="pt-20 text-white bg-[#707278] min-h-screen bg-[url('https://transparenttextures.com/patterns/cubes.png')] font-['quicksand']">
                        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 backdrop-opacity-80 bg-blue-500/60 shadow shadow-lg w-[275px] md:w-[600px] rounded-2xl p-6 px-12">
                                ...
                                <ul>
                                        <Link to="/play/instructions" className="bg-white/60 mb-[40px] cursor-pointer rounded-full hover:bg-white/100 flex justify-center items-center w-[200px] m-auto  p-6 text-center hover:duration-700 transition hover:scale-110 text-white/100 text-sm md:text-2xl hover:text-black/100">Have a Quick Play</Link>
                                </ul>
