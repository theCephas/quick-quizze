...
const Home = () => (
        <Fragment>
                ...
                <div className="bg-[#02001c] bg-[url('https://transparenttextures.com/patterns/asfalt-light.png')] min-h-screen font-['quicksand']">
                        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 backdrop-opacity-10 bg-blue-900/50 w-auto rounded-2xl p-6">
                        ...
                        <div className="flex justify-around mt-16 md:mt-20 mb-20">
                                
                                        <Link to="/register"  className="bg-white/60 text-white/100 hover:bg-white/100 hover:duration-500 text-sm mr-10 md:text-2xl hover:text-black/100 p-4 px-10 md:px-[auto] rounded-full">
                                        SIGN UP
                                        </Link>
